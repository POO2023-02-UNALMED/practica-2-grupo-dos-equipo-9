...
class FieldFrame(Frame):
    ...
    def crearBotones(self, comando1, texto = "Aceptar", Pady = 50, Column= 0, Padx = 0):
        return Button(self, text=texto, foreground="white",background="black",font=("Helvetica", 11), command=comando1).grid(padx = Padx, pady = Pady, column = Column, row = len(self._datos)+1)