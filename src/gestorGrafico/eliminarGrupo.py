...
class eliminarGrupo(Frame):
    def __init__(self, ventana):
        ...
        titulo = Label(self, text="Eliminar Grupo", font=("Arial", 14),  fg="white", bg="black")
        ...
        subFrame = Frame(self, bg="black")
        subFrame.pack(padx=5, pady=5)

        tituloC = Label(subFrame, text="Criterio", font=("Arial", 11), fg="white", bg="black")
        ...
        textoM = Label(subFrame, text="Grupo", font=("Arial", 11), fg="white", bg="black")
