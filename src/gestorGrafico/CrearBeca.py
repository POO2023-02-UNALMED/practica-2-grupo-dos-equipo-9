...
class CrearBeca(Frame):
    def __init__(self, ventana):
        ...
        titulo = Label(self, text="Crear Beca", bg="#000000", foreground="#FFFFFF", font=("Helvetica", 14, "bold"))  # Fondo negro, texto blanco
        ...
        descripcion = Label(self, text=texto, font=("Arial", 11), bg="#000000", fg="#FFFFFF")  # Fondo negro, texto blanco
        descripcion.pack(anchor="n")

        creandoBeca = Frame(self, bg="#000000")  # Fondo negro
        creandoBeca.pack()
        
        crit = Label(creandoBeca, text="Criterios", font=("Arial", 11, "bold"), fg="#FFFFFF", bg="#000000")  # Fondo negro, texto blanco
        crit.grid(row=0, column=0, padx=10, pady=10)

        val = Label(creandoBeca, text="Valores", font=("Arial", 11, "bold"), fg="#FFFFFF", bg="#000000")  # Fondo negro, texto blanco
        val.grid(row=0, column=1, padx=10, pady=5)

        cuposL = Label(creandoBeca, text="Cupos", font=("Arial", 11), fg="#FFFFFF", bg="#000000")
        cuposL.grid(row=1, column=0, padx=10, pady=5)
        cuposE = Entry(creandoBeca, font=("Arial", 11), bg="#FFFFFF", fg="#000000")
        cuposE.grid(row=1, column=1, padx=10, pady=5)
        
        nombreL = Label(creandoBeca, text="Nombre", font=("Arial", 11), fg="#FFFFFF", bg="#000000")
        nombreL.grid(row=2, column=0, padx=10, pady=10)
        nombreE = Entry(creandoBeca, font=("Arial", 11), bg="#FFFFFF", fg="#000000")
        nombreE.grid(row=2, column=1, padx=10, pady=5)

        promedioL = Label(creandoBeca, text="Promedio requerido", font=("Arial", 11), fg="#FFFFFF", bg="#000000")
        promedioL.grid(row=3, column=0, padx=10, pady=5)
        promedioE = Entry(creandoBeca, font=("Arial", 11), bg="#FFFFFF", fg="#000000")
        promedioE.grid(row=3, column=1, padx=10, pady=5)

        avanceL = Label(creandoBeca, text="Avance requerido", font=("Arial", 11), fg="#FFFFFF", bg="#000000")
        avanceL.grid(row=4, column=0, padx=10, pady=5)
        avanceE = Entry(creandoBeca, font=("Arial", 11), bg="#FFFFFF", fg="#000000")
        avanceE.grid(row=4, column=1, padx=10, pady=5)

        estratoL = Label(creandoBeca, text="Estrato máximo\n para aplicar", font=("Arial", 11), fg="#FFFFFF", bg="#000000")
        estratoL.grid(row=5, column=0, padx=10, pady=5)
        estratoE = Entry(creandoBeca, font=("Arial", 11), bg="#FFFFFF", fg="#000000")
        estratoE.grid(row=5, column=1, padx=10, pady=5)

        creditosL = Label(creandoBeca, text="Creditos inscritos\n requeridos", font=("Arial", 11), fg="#FFFFFF", bg="#000000")
        creditosL.grid(row=6, column=0, padx=10, pady=5)
        creditosE = Entry(creandoBeca, font=("Arial", 11), bg="#FFFFFF", fg="#000000")
        creditosE.grid(row=6, column=1, padx=10, pady=5)

        ayudaL = Label(creandoBeca, text="Ayuda económica", font=("Arial", 11), fg="#FFFFFF", bg="#000000")
        ayudaL.grid(row=7, column=0, padx=10, pady=5)
        ayudaE = Entry(creandoBeca, font=("Arial", 11), bg="#FFFFFF", fg="#000000")
        ayudaE.grid(row=7, column=1, padx=10, pady=5)

        recomendacionB = Label(creandoBeca, text="¿La beca necesita\nrecomendación?", font=("Arial", 11), fg="#FFFFFF", bg="#000000")
        recomendacionB.grid(row=8, column=0, padx=10)
        combo = ttk.Combobox(creandoBeca, values=["Si.","No."])
        combo.grid(row=8, column=1, padx=10)

        boton =  boton = Button(self, text="Crear Beca", command=crear, font=("Arial", 11, "bold"), fg="#FFFFFF", bg="#000000")
        boton.pack()
